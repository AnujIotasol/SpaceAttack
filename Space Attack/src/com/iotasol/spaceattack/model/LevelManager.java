package com.iotasol.spaceattack.model;
...
public class LevelManager {
	...
	List<LevelConfig> LEVEL_INFO = Arrays.asList(
		...
		new LevelConfig(30, Arrays.asList(new LevelBulletConfig(70, Bullet.class),
										  new LevelBulletConfig(20, StopAndGoBullet.class),
										  new LevelBulletConfig(10, SineWaveBullet.class))),
										  
	    new LevelConfig(40, Arrays.asList(new LevelBulletConfig(55, Bullet.class),
    									  new LevelBulletConfig(25, StopAndGoBullet.class),
			                              new LevelBulletConfig(20, SineWaveBullet.class)))
